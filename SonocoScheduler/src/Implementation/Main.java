...
public class Main {
	...
	public static void main(String[] args) {
		...
		factory.InitializePress(new Press(1, 50, 3, 100, 1));
		factory.InitializePress(new Press(2, 280, 6, 100, 2));
		factory.InitializePress(new Press(3, 40, 3, 100, 3));
		factory.InitializePress(new Press(4, 30, 3, 100, 4));
		factory.InitializePress(new Press(5, 20, 3, 100, 5));
		factory.InitializePress(new Press(6, 10, 3, 100, 6));
